...
<div class="wrap lingua-settings-page">
    ...
    <div class="nav-tab-wrapper" style="margin-bottom: 20px;">
        ...
        <a href="#tab-shortcode" class="nav-tab">📝 Shortcode</a> <!-- LIEN AJOUTÉ ICI -->
    ...
    <form method="post" action="options.php">
        ...
        <div id="tab-frontend" class="lingua-tab-content" style="display:none; background:#fff; padding:20px; border:1px solid #ccc;">
            ...
            <table class="form-table" style="margin-top:30px; border-top:1px solid #eee; padding-top:20px;">
                <tr>
                   ...
                   <!-- NOUVEAU : SECTION POSITIONNEMENT -->
                <tr>
        ...
        <!-- ONGLET 3 : SHORTCODE (NOUVELLE POSITION) -->
        <div id="tab-shortcode" class="lingua-tab-content" style="display:none; background:#fff; padding:20px; border:1px solid #ccc;">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="lingua_commerce_ai_settings[sc_show_name]" value="1" <?php checked( isset($settings['sc_show_name']) ? $settings['sc_show_name'] : 0, 1 ); ?>>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="lingua_commerce_ai_settings[sc_hide_current]" value="1" <?php checked( isset($settings['sc_hide_current']) ? $settings['sc_hide_current'] : 0, 1 ); ?>>
                            Ne pas afficher la langue actuelle dans la liste
                        </label>
                    </td>
                </tr>
                 <tr>
        ...
        <div id="tab-automation" class="lingua-tab-content" style="display:none; background:#fff; padding:20px; border:1px solid #ccc;">
             <table class="form-table">
                <tr>
                    ...
                    <td>
                        <input type="number" name="lingua_commerce_ai_settings[batch_size]" value="<?php echo esc_attr( $batch_size ); ?>" min="1" max="50">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="lingua_commerce_ai_settings[auto_publish_queue]" value="1" <?php checked( $auto_publish, 1 ); ?>>
                            Envoyer en traduction automatique dès la publication
                        </label>
                    </td>
                </tr>
                <tr>
        ...
        <div id="tab-maintenance" class="lingua-tab-content" style="display:none; background:#fff; padding:20px; border:1px solid #ccc;">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <a href="<?php echo admin_url( 'admin.php?page=lingua-commerce-ai-tools' ); ?>" class="button">📁 Exporter les Réglages</a>
                    </td>
                </tr>
            </table>
        </div>
